...
quint32 ZoneFile_COD2::pParseZoneSize(QDataStream *aZoneFileStream) {
...
*/
void ZoneFile_COD2::pParseZoneUnknownsA(QDataStream *aZoneFileStream) {
...
*/
quint32 ZoneFile_COD2::pParseZoneTagCount(QDataStream *aZoneFileStream) {
    quint32 tagCount;
...
*/
quint32 ZoneFile_COD2::pParseZoneRecordCount(QDataStream *aZoneFileStream) {
    quint32 recordCount;
...
*/
void ZoneFile_COD2::pParseZoneUnknownsB(QDataStream *aZoneFileStream) {
...
*/
void ZoneFile_COD2::pParseZoneUnknownsC(QDataStream *aZoneFileStream) {
...
*/
QStringList ZoneFile_COD2::pParseZoneTags(QDataStream *aZoneFileStream, quint32 tagCount) {
    QStringList tags;
...
*/
QStringList ZoneFile_COD2::pParseZoneIndex(QDataStream *aZoneFileStream, quint32 recordCount) {
    QStringList result;
...
AssetMap ZoneFile_COD2::pParseAssets(QDataStream *aZoneFileStream, QStringList assetOrder) {
    AssetMap result;
    ...
    for (int i = 0; i < assetOrder.size(); i++) {
        ...
        const QString typeStr = AssetTypeToString(typeHex);
...
LocalString ZoneFile_COD2::pParseAsset_LocalString(QDataStream *aZoneFileStream) {
    LocalString result;
...
RawFile ZoneFile_COD2::pParseAsset_RawFile(QDataStream *aZoneFileStream) {
    RawFile result;
...
void ZoneFile_COD2::pParseAsset_PhysPreset(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

Model ZoneFile_COD2::pParseAsset_Model(QDataStream *aZoneFileStream) {
    Model result;
...
Shader ZoneFile_COD2::pParseAsset_Shader(QDataStream *aZoneFileStream) {
...
TechSet ZoneFile_COD2::pParseAsset_TechSet(QDataStream *aZoneFileStream) {
    TechSet result;
...
Image ZoneFile_COD2::pParseAsset_Image(QDataStream *aZoneFileStream) {
    Image result;
...
Material ZoneFile_COD2::pParseAsset_Material(QDataStream *aZoneFileStream) {
    Material result;

    *aZoneFileStream >> result.namePtr;
    if (result.namePtr != 4294967295 && GetTagCount() > result.namePtr - 1) {
    ...
    *aZoneFileStream >> result.unknownA[0] >> result.unknownA[0]
        >> result.unknownA[1] >> result.unknownA[2] >> result.unknownA[3]
        >> result.unknownA[4] >> result.unknownA[5] >> result.unknownA[6]
        >> result.unknownA[7] >> result.unknownA[8] >> result.unknownA[9]
        >> result.unknownA[10] >> result.unknownA[11];
...
SoundAsset ZoneFile_COD2::pParseAsset_Sound(QDataStream *aZoneFileStream) {
    SoundAsset result;
...
void ZoneFile_COD2::pParseAsset_ColMapMP(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2::pParseAsset_GameMapSP(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2::pParseAsset_GameMapMP(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2::pParseAsset_LightDef(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2::pParseAsset_UIMap(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2::pParseAsset_SNDDriverGlobals(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2::pParseAsset_AIType(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2::pParseAsset_FX(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

Animation ZoneFile_COD2::pParseAsset_Animation(QDataStream *aZoneFileStream) {
    Animation result;
...
MenuFile ZoneFile_COD2::pParseAsset_MenuFile(QDataStream *aZoneFileStream) {
    //MENU_FILE
    MenuFile result;
...
void ZoneFile_COD2::pParseAsset_Weapon(QDataStream *aZoneFileStream) {
    //WEAPON_FILE
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2::pParseAsset_D3DBSP(QDataStream *aZoneFileStream) {
    //D3DBSP_DUMP
    Q_UNUSED(aZoneFileStream);
}

StringTable ZoneFile_COD2::pParseAsset_StringTable(QDataStream *aZoneFileStream) {
    StringTable result;
