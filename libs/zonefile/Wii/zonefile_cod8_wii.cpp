...
void ZoneFile_COD8_Wii::pParseZoneHeader(QDataStream *aZoneFileStream) {
...
quint32 ZoneFile_COD8_Wii::pParseZoneSize(QDataStream *aZoneFileStream) {
...
*/
void ZoneFile_COD8_Wii::pParseZoneUnknownsA(QDataStream *aZoneFileStream) {
...
*/
quint32 ZoneFile_COD8_Wii::pParseZoneTagCount(QDataStream *aZoneFileStream) {
    quint32 tagCount;
...
*/
quint32 ZoneFile_COD8_Wii::pParseZoneRecordCount(QDataStream *aZoneFileStream) {
    quint32 recordCount;
...
*/
void ZoneFile_COD8_Wii::pParseZoneUnknownsB(QDataStream *aZoneFileStream) {
...
*/
void ZoneFile_COD8_Wii::pParseZoneUnknownsC(QDataStream *aZoneFileStream) {
...
*/
QStringList ZoneFile_COD8_Wii::pParseZoneTags(QDataStream *aZoneFileStream, quint32 tagCount) {
    QStringList tags;
...
*/
QStringList ZoneFile_COD8_Wii::pParseZoneIndex(QDataStream *aZoneFileStream, quint32 recordCount) {
    QStringList result;
...
AssetMap ZoneFile_COD8_Wii::pParseAssets(QDataStream *aZoneFileStream, QStringList assetOrder) {
    AssetMap result;
...
LocalString ZoneFile_COD8_Wii::pParseAsset_LocalString(QDataStream *aZoneFileStream) {
    LocalString result;
...
RawFile ZoneFile_COD8_Wii::pParseAsset_RawFile(QDataStream *aZoneFileStream) {
    RawFile result;
...
void ZoneFile_COD8_Wii::pParseAsset_PhysPreset(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

Model ZoneFile_COD8_Wii::pParseAsset_Model(QDataStream *aZoneFileStream) {
    Model result;
...
Material ZoneFile_COD8_Wii::pParseAsset_Material(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);

    return Material();
}

Shader ZoneFile_COD8_Wii::pParseAsset_Shader(QDataStream *aZoneFileStream) {
...
TechSet ZoneFile_COD8_Wii::pParseAsset_TechSet(QDataStream *aZoneFileStream) {
    TechSet result;
...
Image ZoneFile_COD8_Wii::pParseAsset_Image(QDataStream *aZoneFileStream) {
    Image result;
...
SoundAsset ZoneFile_COD8_Wii::pParseAsset_Sound(QDataStream *aZoneFileStream) {
    SoundAsset result;
...
void ZoneFile_COD8_Wii::pParseAsset_ColMapMP(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD8_Wii::pParseAsset_GameMapSP(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD8_Wii::pParseAsset_GameMapMP(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD8_Wii::pParseAsset_LightDef(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD8_Wii::pParseAsset_UIMap(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD8_Wii::pParseAsset_SNDDriverGlobals(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD8_Wii::pParseAsset_AIType(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD8_Wii::pParseAsset_FX(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

Animation ZoneFile_COD8_Wii::pParseAsset_Animation(QDataStream *aZoneFileStream) {
    Animation result;
...
MenuFile ZoneFile_COD8_Wii::pParseAsset_MenuFile(QDataStream *aZoneFileStream) {
    //MENU_FILE
    MenuFile result;
...
void ZoneFile_COD8_Wii::pParseAsset_Weapon(QDataStream *aZoneFileStream) {
    //WEAPON_FILE
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD8_Wii::pParseAsset_D3DBSP(QDataStream *aZoneFileStream) {
    //D3DBSP_DUMP
    Q_UNUSED(aZoneFileStream);
}

StringTable ZoneFile_COD8_Wii::pParseAsset_StringTable(QDataStream *aZoneFileStream) {
    StringTable result;
...
AssetType ZoneFile_COD8_Wii::AssetStrToEnum(const QString aAssetType) {
...
QByteArray ZoneFile_COD8_Wii::GetBinaryData() {
    QByteArray result;
