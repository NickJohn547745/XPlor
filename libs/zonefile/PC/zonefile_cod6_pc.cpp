...
void ZoneFile_COD6_PC::pParseZoneHeader(QDataStream *aZoneFileStream) {
...
quint32 ZoneFile_COD6_PC::pParseZoneSize(QDataStream *aZoneFileStream) {
...
*/
void ZoneFile_COD6_PC::pParseZoneUnknownsA(QDataStream *aZoneFileStream) {
...
*/
quint32 ZoneFile_COD6_PC::pParseZoneTagCount(QDataStream *aZoneFileStream) {
    quint32 tagCount;
...
*/
quint32 ZoneFile_COD6_PC::pParseZoneRecordCount(QDataStream *aZoneFileStream) {
    quint32 recordCount;
...
*/
void ZoneFile_COD6_PC::pParseZoneUnknownsB(QDataStream *aZoneFileStream) {
...
*/
void ZoneFile_COD6_PC::pParseZoneUnknownsC(QDataStream *aZoneFileStream) {
...
*/
QStringList ZoneFile_COD6_PC::pParseZoneTags(QDataStream *aZoneFileStream, quint32 tagCount) {
    QStringList tags;
...
*/
QStringList ZoneFile_COD6_PC::pParseZoneIndex(QDataStream *aZoneFileStream, quint32 recordCount) {
    QStringList result;
...
AssetMap ZoneFile_COD6_PC::pParseAssets(QDataStream *aZoneFileStream, QStringList assetOrder) {
    AssetMap result;
...
LocalString ZoneFile_COD6_PC::pParseAsset_LocalString(QDataStream *aZoneFileStream) {
    LocalString result;
...
RawFile ZoneFile_COD6_PC::pParseAsset_RawFile(QDataStream *aZoneFileStream) {
    RawFile result;
...
void ZoneFile_COD6_PC::pParseAsset_PhysPreset(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

Model ZoneFile_COD6_PC::pParseAsset_Model(QDataStream *aZoneFileStream) {
    Model result;
...
Material ZoneFile_COD6_PC::pParseAsset_Material(QDataStream *aZoneFileStream) {
...
Shader ZoneFile_COD6_PC::pParseAsset_Shader(QDataStream *aZoneFileStream) {
...
TechSet ZoneFile_COD6_PC::pParseAsset_TechSet(QDataStream *aZoneFileStream) {
    TechSet result;
...
Image ZoneFile_COD6_PC::pParseAsset_Image(QDataStream *aZoneFileStream) {
    Image result;
...
SoundAsset ZoneFile_COD6_PC::pParseAsset_Sound(QDataStream *aZoneFileStream) {
    SoundAsset result;
...
void ZoneFile_COD6_PC::pParseAsset_ColMapMP(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD6_PC::pParseAsset_GameMapSP(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD6_PC::pParseAsset_GameMapMP(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD6_PC::pParseAsset_LightDef(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD6_PC::pParseAsset_UIMap(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD6_PC::pParseAsset_SNDDriverGlobals(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD6_PC::pParseAsset_AIType(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD6_PC::pParseAsset_FX(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

Animation ZoneFile_COD6_PC::pParseAsset_Animation(QDataStream *aZoneFileStream) {
    Animation result;
...
MenuFile ZoneFile_COD6_PC::pParseAsset_MenuFile(QDataStream *aZoneFileStream) {
    //MENU_FILE
    MenuFile result;
...
void ZoneFile_COD6_PC::pParseAsset_Weapon(QDataStream *aZoneFileStream) {
    //WEAPON_FILE
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD6_PC::pParseAsset_D3DBSP(QDataStream *aZoneFileStream) {
    //D3DBSP_DUMP
    Q_UNUSED(aZoneFileStream);
}

StringTable ZoneFile_COD6_PC::pParseAsset_StringTable(QDataStream *aZoneFileStream) {
    StringTable result;
...
AssetType ZoneFile_COD6_PC::AssetStrToEnum(const QString aAssetType) {
...
QByteArray ZoneFile_COD6_PC::GetBinaryData() {
    QByteArray result;
