...
LocalString ZoneFile_COD6_360::pParseAsset_LocalString(QDataStream *aZoneFileStream) {
    LocalString result;
...
Model ZoneFile_COD6_360::pParseAsset_Model(QDataStream *aZoneFileStream) {
    Model result;
...
TechSet ZoneFile_COD6_360::pParseAsset_TechSet(QDataStream *aZoneFileStream) {
    TechSet result;
...
void ZoneFile_COD6_360::pParseAsset_SNDDriverGlobals(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}
...
MenuFile ZoneFile_COD6_360::pParseAsset_MenuFile(QDataStream *aZoneFileStream) {
    //MENU_FILE
    MenuFile result;
...
AssetType ZoneFile_COD6_360::AssetStrToEnum(const QString aAssetType) {
...
QByteArray ZoneFile_COD6_360::GetBinaryData() {
    QByteArray result;
