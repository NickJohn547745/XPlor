...
quint32 ZoneFile_COD2_360::pParseZoneSize(QDataStream *aZoneFileStream) {
...
*/
void ZoneFile_COD2_360::pParseZoneUnknownsA(QDataStream *aZoneFileStream) {
...
*/
quint32 ZoneFile_COD2_360::pParseZoneTagCount(QDataStream *aZoneFileStream) {
    quint32 tagCount;
...
*/
quint32 ZoneFile_COD2_360::pParseZoneRecordCount(QDataStream *aZoneFileStream) {
    quint32 recordCount;
...
*/
void ZoneFile_COD2_360::pParseZoneUnknownsB(QDataStream *aZoneFileStream) {
...
*/
void ZoneFile_COD2_360::pParseZoneUnknownsC(QDataStream *aZoneFileStream) {
...
*/
QStringList ZoneFile_COD2_360::pParseZoneTags(QDataStream *aZoneFileStream, quint32 tagCount) {
    QStringList tags;

    // Byte 48-51: Repeated separators? ÿÿÿÿ x i
    aZoneFileStream->skipRawData(4 * tagCount);
...
*/
QStringList ZoneFile_COD2_360::pParseZoneIndex(QDataStream *aZoneFileStream, quint32 recordCount) {
    QStringList result;
...
AssetMap ZoneFile_COD2_360::pParseAssets(QDataStream *aZoneFileStream, QStringList assetOrder) {
    AssetMap result;
    ...
    for (int i = 0; i < assetOrder.size(); i++) {
        ...
        const AssetType assetType = AssetStrToEnum(typeHex);

        if (assetType == ASSET_LOCAL_STRING) { // localized string asset
            result.localStrings << pParseAsset_LocalString(aZoneFileStream);
        } else if (assetType == ASSET_RAW_FILE) { // gsc
            auto rawFile = pParseAsset_RawFile(aZoneFileStream);
            if (rawFile.length) {
                result.rawFiles << rawFile;
            }
        } else if (assetType == ASSET_PHYS_PRESET) { // physpreset
            pParseAsset_PhysPreset(aZoneFileStream);
        } else if (assetType == ASSET_MODEL) { // xmodel
            result.models << pParseAsset_Model(aZoneFileStream);
        } else if (assetType == ASSET_MATERIAL) { // material
...
LocalString ZoneFile_COD2_360::pParseAsset_LocalString(QDataStream *aZoneFileStream) {
    LocalString result;
...
void ZoneFile_COD2_360::pParseAsset_PhysPreset(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

Model ZoneFile_COD2_360::pParseAsset_Model(QDataStream *aZoneFileStream) {
    Model result;
...
Shader ZoneFile_COD2_360::pParseAsset_Shader(QDataStream *aZoneFileStream) {
...
TechSet ZoneFile_COD2_360::pParseAsset_TechSet(QDataStream *aZoneFileStream) {
    TechSet result;
...
Image ZoneFile_COD2_360::pParseAsset_Image(QDataStream *aZoneFileStream) {
    Image result;
...
Material ZoneFile_COD2_360::pParseAsset_Material(QDataStream *aZoneFileStream) {
    Material result;

    *aZoneFileStream >> result.namePtr;
    if (result.namePtr != quint32(-1) && result.namePtr > 0 &&
        GetTagCount() > static_cast<quint32>(result.namePtr - 1)) {
        result.name = GetTags()[result.namePtr - 1];
    }
    *aZoneFileStream >> result.refNamePtr;
    if (result.refNamePtr != 4294967295 && GetTagCount() > result.refNamePtr - 1) {
        result.refName = GetTags()[result.refNamePtr - 1];
    }
    ...
    *aZoneFileStream >> result.stateBits[0] >> result.stateBits[1]
        >> result.textureCount >> result.constCount >> result.techSetPtr
        >> result.texturePtr >> result.constPtr;


    return result;
}

SoundAsset ZoneFile_COD2_360::pParseAsset_Sound(QDataStream *aZoneFileStream) {
    SoundAsset result;
...
void ZoneFile_COD2_360::pParseAsset_ColMapMP(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2_360::pParseAsset_GameMapSP(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2_360::pParseAsset_GameMapMP(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2_360::pParseAsset_LightDef(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2_360::pParseAsset_UIMap(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2_360::pParseAsset_SNDDriverGlobals(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2_360::pParseAsset_AIType(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2_360::pParseAsset_FX(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

Animation ZoneFile_COD2_360::pParseAsset_Animation(QDataStream *aZoneFileStream) {
    Animation result;
...
MenuFile ZoneFile_COD2_360::pParseAsset_MenuFile(QDataStream *aZoneFileStream) {
    //MENU_FILE
    MenuFile result;
...
void ZoneFile_COD2_360::pParseAsset_Weapon(QDataStream *aZoneFileStream) {
    //WEAPON_FILE
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD2_360::pParseAsset_D3DBSP(QDataStream *aZoneFileStream) {
    //D3DBSP_DUMP
    Q_UNUSED(aZoneFileStream);
}

StringTable ZoneFile_COD2_360::pParseAsset_StringTable(QDataStream *aZoneFileStream) {
    StringTable result;
...
QByteArray ZoneFile_COD2_360::GetBinaryData() {
    QByteArray result;
