...
void ZoneFile_COD12_360::pParseZoneHeader(QDataStream *aZoneFileStream) {
    quint32 tagCount = pParseZoneTagCount(aZoneFileStream);
    SetTagCount(tagCount);

    aZoneFileStream->skipRawData(7 * 4);

    quint32 recordCount = pParseZoneRecordCount(aZoneFileStream) - 1;
    SetRecordCount(recordCount);

    aZoneFileStream->skipRawData(5 * 4);
...
quint32 ZoneFile_COD12_360::pParseZoneSize(QDataStream *aZoneFileStream) {
...
*/
void ZoneFile_COD12_360::pParseZoneUnknownsA(QDataStream *aZoneFileStream) {
...
*/
quint32 ZoneFile_COD12_360::pParseZoneTagCount(QDataStream *aZoneFileStream) {
    quint32 tagCount;
...
*/
quint32 ZoneFile_COD12_360::pParseZoneRecordCount(QDataStream *aZoneFileStream) {
    quint32 recordCount;
...
*/
void ZoneFile_COD12_360::pParseZoneUnknownsB(QDataStream *aZoneFileStream) {
...
*/
void ZoneFile_COD12_360::pParseZoneUnknownsC(QDataStream *aZoneFileStream) {
...
*/
QStringList ZoneFile_COD12_360::pParseZoneTags(QDataStream *aZoneFileStream, quint32 tagCount) {
    QStringList tags;

    // Byte 48-51: Repeated separators? ÿÿÿÿ x i
    aZoneFileStream->skipRawData(8 * (tagCount - 1));

    // Parse tags/strings before index
    QString zoneTag;
    char zoneTagChar;
    for (quint32 i = 0; i < tagCount; i++) {
        if (aZoneFileStream->device()->peek(8).toHex().contains("00000000")) {
            break;
        }
...
*/
QStringList ZoneFile_COD12_360::pParseZoneIndex(QDataStream *aZoneFileStream, quint32 recordCount) {
    QStringList result;
    ...
    for (quint32 i = 0; i <= recordCount; i++) {
        // Skip record start
        QByteArray rawAssetType(8, Qt::Uninitialized);
        aZoneFileStream->readRawData(rawAssetType.data(), 8);
...
AssetMap ZoneFile_COD12_360::pParseAssets(QDataStream *aZoneFileStream, QStringList assetOrder) {
    AssetMap result;
    ...
    for (int i = 0; i < assetOrder.size(); i++) {
        ...
        } else if (typeStr == ASSET_RAW_FILE) { // raw file
            auto rawFile = pParseAsset_RawFile(aZoneFileStream);
            if (rawFile.length) {
                result.rawFiles << rawFile;
            }
        } else if (typeStr == ASSET_SCRIPT_PARSE_TREE) { // gsc
            auto gscFile = pParseAsset_GSCFile(aZoneFileStream);
            if (gscFile.length) {
                result.gscFiles << gscFile;
            }
...
LocalString ZoneFile_COD12_360::pParseAsset_LocalString(QDataStream *aZoneFileStream) {
    LocalString result;
...
RawFile ZoneFile_COD12_360::pParseAsset_RawFile(QDataStream *aZoneFileStream) {
    RawFile result;
...
GscFile ZoneFile_COD12_360::pParseAsset_GSCFile(QDataStream *aZoneFileStream) {
    GscFile result;
...
void ZoneFile_COD12_360::pParseAsset_PhysPreset(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

Model ZoneFile_COD12_360::pParseAsset_Model(QDataStream *aZoneFileStream) {
    Model result;
...
Material ZoneFile_COD12_360::pParseAsset_Material(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);

    return Material();
}

Shader ZoneFile_COD12_360::pParseAsset_Shader(QDataStream *aZoneFileStream) {
...
TechSet ZoneFile_COD12_360::pParseAsset_TechSet(QDataStream *aZoneFileStream) {
    TechSet result;
...
Image ZoneFile_COD12_360::pParseAsset_Image(QDataStream *aZoneFileStream) {
    Image result;
...
SoundAsset ZoneFile_COD12_360::pParseAsset_Sound(QDataStream *aZoneFileStream) {
    SoundAsset result;
    return result;
...
void ZoneFile_COD12_360::pParseAsset_ColMapMP(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD12_360::pParseAsset_GameMapSP(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD12_360::pParseAsset_GameMapMP(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD12_360::pParseAsset_LightDef(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD12_360::pParseAsset_UIMap(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD12_360::pParseAsset_SNDDriverGlobals(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD12_360::pParseAsset_AIType(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD12_360::pParseAsset_FX(QDataStream *aZoneFileStream) {
    Q_UNUSED(aZoneFileStream);
}

Animation ZoneFile_COD12_360::pParseAsset_Animation(QDataStream *aZoneFileStream) {
    Animation result;
...
MenuFile ZoneFile_COD12_360::pParseAsset_MenuFile(QDataStream *aZoneFileStream) {
    //MENU_FILE
    MenuFile result;
...
void ZoneFile_COD12_360::pParseAsset_Weapon(QDataStream *aZoneFileStream) {
    //WEAPON_FILE
    Q_UNUSED(aZoneFileStream);
}

void ZoneFile_COD12_360::pParseAsset_D3DBSP(QDataStream *aZoneFileStream) {
    //D3DBSP_DUMP
    Q_UNUSED(aZoneFileStream);
}

StringTable ZoneFile_COD12_360::pParseAsset_StringTable(QDataStream *aZoneFileStream) {
    StringTable result;
...
AssetType ZoneFile_COD12_360::AssetStrToEnum(const QString aAssetType) {
    ...
    if (cleanedType == "0000000000000000") {
        ...
        return ASSET_CG_MEDIA_TABLE;
    }

    return ASSET_NONE;
}

QByteArray ZoneFile_COD12_360::GetBinaryData() {
    QByteArray result;
